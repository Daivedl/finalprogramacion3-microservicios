package com.formacionbdi.microservicios.app.respuestas.models.respository;
...
public interface RespuestaRepository extends MongoRepository<Respuesta, String> {
	...
	//en una sola consulta entregue todos los examenes respondidos por el alumno
	
	@Query("{'alumnoId': ?0, 'preguntaId': { $in: ?1} }")
	public Iterable<Respuesta> findRespuestaByAlumnoByPreguntaIds(Long alumnoId, Iterable<Long> preguntasIds);
